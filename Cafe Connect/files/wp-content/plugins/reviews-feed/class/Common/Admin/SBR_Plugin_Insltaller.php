...
class SBR_Plugin_Insltaller extends ServiceProvider{
    ...
    function activate_plugin()
    {
        ...
        wp_send_json_error(
            __('Could not Activate the Plugin. Please Activate from the Plugins page.', 'sb-customizer')
        );
    ...
    function deactivate_plugin()
    {
        ...
        wp_send_json_error(
            __('Could not deactivate the Plugin. Please deactivate from the Plugins page.', 'sb-customizer')
        );
