...
if ( class_exists( 'WP_Customize_Section' ) ) {
	...
	class Coffee_Bistro_Upsell_Section extends WP_Customize_Section {
		...
		protected function render() {
			...
			?>
			<li id="accordion-section-<?php echo esc_attr( $this->id ); ?>" class="coffee_bistro_upsell_section accordion-section control-section control-section-<?php echo esc_attr( $this->id ); ?> cannot-expand">
