...
function cafe_coffee_shop_setup() {
	...
	if (is_admin() && ('themes.php' == $pagenow) && isset($_GET['activated']) && wp_get_theme()->get('TextDomain') === 'cafe-coffee-shop') {
		wp_redirect(admin_url('themes.php?page=cafe_coffee_shop_guide'));
	}
}
endif;
