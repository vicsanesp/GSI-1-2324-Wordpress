...
if ( class_exists( 'WP_Customize_Control' ) ) {
	...
	// Reset Settings
	class VW_Restaurant_Lite_Reset_Custom_Control extends WP_Customize_Control {
        ...
        ?>
            <div class="reset-custom-control">
                ...
                <span class="reset-button"><?php echo esc_html_e('Reset', 'vw-restaurant-lite'); ?></span>
            </div>
            <div id="myModal" class="modal kt-modal">
              <div class="modal-content">
                <span class="close">X</span>
                <h3><?php esc_html_e('Are you sure to reset setting ? ', 'vw-restaurant-lite') ?></h3>
                <p><?php esc_html_e('After click on the reset settings, it will reset the content and the content will be lost in this section.', 'vw-restaurant-lite') ?></p>
                <a href="javascript:location.reload();" class="refresh-btn" data-value="<?php echo esc_attr( $this->description ); ?>"><?php echo esc_html_e('OK', 'vw-restaurant-lite'); ?></a>
              </div>
