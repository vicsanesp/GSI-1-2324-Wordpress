...
* Added default slider button text for customizer.
* Resolved css error for product heading text.
* Update language folder.
...
* Resolved header background color option in customizer.
...
* Merienda One *
* Source : https://fonts.google.com/specimen/Merienda?query=Merienda+
