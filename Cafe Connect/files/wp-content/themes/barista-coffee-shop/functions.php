...
function barista_coffee_shop_scripts() {
	...
	wp_add_inline_style( 'barista-coffee-shop-style',$barista_coffee_shop_theme_css );
...
function barista_coffee_shop_preloader() {
  ...
  $barista_coffee_shop_logo_max_height = get_theme_mod('barista_coffee_shop_logo_max_height');

  	if(get_theme_mod('barista_coffee_shop_logo_max_height') == '') {
		$barista_coffee_shop_logo_max_height = '24';
	}
	...
	$barista_coffee_shop_theme_color_css = '
		.custom-logo-link img{
			max-height: '.esc_attr($barista_coffee_shop_logo_max_height).'px;
	 	}
		.loading{
...
function barista_coffee_shop_sanitize_choices( $input, $setting ) {
    global $wp_customize;
...
function barista_coffee_shop_sanitize_number_absint( $number, $setting ) {
...
function barista_coffee_shop_page_redirection() {
	global $pagenow;
		if (isset($_GET['activated']) && ('themes.php' == $pagenow) && is_admin()) {
		wp_safe_redirect(admin_url("themes.php?page=barista-coffee-shop-info.php"));
	}
}
add_action('after_setup_theme', 'barista_coffee_shop_page_redirection');
