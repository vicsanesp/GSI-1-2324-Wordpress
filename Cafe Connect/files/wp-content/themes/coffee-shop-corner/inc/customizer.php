...
function coffee_shop_corner_customize_register( $wp_customize ) {
	...
	$wp_customize->add_setting( 'coffee_shop_corner_site_title_color', array(
		'default' => '',
		'sanitize_callback' => 'sanitize_hex_color'
	));
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'coffee_shop_corner_site_title_color', array(
		'label' => 'Title Color',
		'section' => 'title_tagline',
	)));
	...
	$wp_customize->add_setting( 'coffee_shop_corner_site_tagline_color', array(
		'default' => '',
		'sanitize_callback' => 'sanitize_hex_color'
	));
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'coffee_shop_corner_site_tagline_color', array(
		'label' => 'Tagline Color',
		'section' => 'title_tagline',
	)));
	...
	$wp_customize->add_setting( 'coffee_shop_corner_menu_color', array(
		'default' => '',
		'sanitize_callback' => 'sanitize_hex_color'
	));
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'coffee_shop_corner_menu_color', array(
		'label' => 'Menu Color',
		'section' => 'coffee_shop_corner_header_section',
	)));

	$wp_customize->add_setting( 'coffee_shop_corner_menuhvr_color', array(
		'default' => '',
		'sanitize_callback' => 'sanitize_hex_color'
	));
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'coffee_shop_corner_menuhvr_color', array(
	...
	$wp_customize->add_setting('coffee_shop_corner_slider_excerpt_length',array(
		'default' => '15',
		'sanitize_callback'	=> 'coffee_shop_corner_sanitize_float'
	));
	$wp_customize->add_control('coffee_shop_corner_slider_excerpt_length',array(
		'type' => 'number',
		'label' => __('Slider Excerpt Length','coffee-shop-corner'),
		'section' => 'coffee_shop_corner_slider_section',
	));
    ...
    $wp_customize->add_section( 'coffee_shop_corner_footer', array(
    	'title'  => __( 'Footer Setting', 'coffee-shop-corner' ),
		'priority' => null,
		'panel' => 'coffee_shop_corner_panel_id'
	) );
	...
	$wp_customize->add_control('coffee_shop_corner_footer_copy',array(
		'label'	=> __('Copyright Text','coffee-shop-corner'),
		'section' => 'coffee_shop_corner_footer',
	...
	$wp_customize->add_control('coffee_shop_corner_footer_copylink',array(
		'label'	=> __('Copyright Link','coffee-shop-corner'),
		'section' => 'coffee_shop_corner_footer',
		'setting' => 'coffee_shop_corner_footer_copylink',
		'type' => 'text'
	));

	$wp_customize->add_setting( 'coffee_shop_corner_copyright_color', array(
		'default' => '',
		'sanitize_callback' => 'sanitize_hex_color'
	));
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'coffee_shop_corner_copyright_color', array(
		'label' => 'Text Color',
		'section' => 'coffee_shop_corner_footer',
	)));
