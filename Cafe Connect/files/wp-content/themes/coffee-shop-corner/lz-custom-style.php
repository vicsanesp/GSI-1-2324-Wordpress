<?php 
	...
	$coffee_shop_corner_site_title_color = get_theme_mod('coffee_shop_corner_site_title_color');
	if ( $coffee_shop_corner_site_title_color != '') {
		$coffee_shop_corner_custom_style .=' .logo h1.site-title a, .logo p.site-title a {';
			$coffee_shop_corner_custom_style .=' color:'.esc_attr($coffee_shop_corner_site_title_color).';';
		$coffee_shop_corner_custom_style .=' }';
	}
	...
	$coffee_shop_corner_menu_color = get_theme_mod('coffee_shop_corner_menu_color');
	if ( $coffee_shop_corner_menu_color != '') {
		$coffee_shop_corner_custom_style .=' .nav-menu ul li a {';
			$coffee_shop_corner_custom_style .=' color:'.esc_attr($coffee_shop_corner_menu_color).';';
		$coffee_shop_corner_custom_style .=' }';
	}

	$coffee_shop_corner_menuhvr_color = get_theme_mod('coffee_shop_corner_menuhvr_color');
	if ( $coffee_shop_corner_menuhvr_color != '') {
		$coffee_shop_corner_custom_style .=' .nav-menu ul li a:hover {';
			$coffee_shop_corner_custom_style .=' color:'.esc_attr($coffee_shop_corner_menuhvr_color).';';
		$coffee_shop_corner_custom_style .=' }';
	}
	...
	//footer color
	$coffee_shop_corner_copyright_color = get_theme_mod('coffee_shop_corner_copyright_color');
	if ( $coffee_shop_corner_copyright_color != '') {
		$coffee_shop_corner_custom_style .=' .site-info p, .site-info a {';
			$coffee_shop_corner_custom_style .=' color:'.esc_attr($coffee_shop_corner_copyright_color).';';
		$coffee_shop_corner_custom_style .=' }';
	}