					        		...
					        		<div class="col-lg-5 col-md-5 align-self-center">
					        			<div class="carousel-caption">
								            <div class="inner-carousel">
												...
												<p class="mb-0"><?php $coffee_shop_corner_excerpt = get_the_excerpt(); echo esc_html( coffee_shop_corner_string_limit_words( $coffee_shop_corner_excerpt, esc_attr(get_theme_mod('coffee_shop_corner_slider_excerpt_length','15') ) )); ?></p>
